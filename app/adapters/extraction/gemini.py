...
class GeminiExtractor(IExtractor):
    ...
    SYSTEM_PROMPT = """أنت مستكشف مواد تحريرية من الكتب، ولست ملخّصاً للفهرس أو الوصف الببليوغرافي. تجاهل الفهارس وقوائم المراجع عندما لا تكون هي المادة الأصلية المقصودة.
