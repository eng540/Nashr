...
اكتشف من متن الكتاب المواد التي يمكن أن تصبح أساساً لمحتوى تحريري جيد.
أعد صفر مادة أو أكثر؛ لا تحاول ملء عدد محدد من العناصر.
لا تخترع معلومات أو اقتباسات.
إذا أمكن تحديد الصفحة أو الموضع من الوثيقة، أعده في source_reference. لا تخمن أرقام الصفحات.
رقّم المواد بترتيب ظهورها أو أهميتها ابتداءً من 1."""
